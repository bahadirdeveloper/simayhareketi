      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto mb-8">
            <div className="bg-black/40 backdrop-blur-sm px-3 py-3 rounded-lg border border-red-500/30 shadow-lg">
              <div className="flex flex-col items-center">
                <div className="flex items-center">
                  <div className="h-2.5 w-2.5 bg-white rounded-full mr-2"></div>
                  <h4 className="font-medium text-white text-xs sm:text-sm">GENEL KATILIM</h4>
                </div>
                <motion.div 
                  className="text-xl sm:text-2xl font-bold text-white mt-1.5"
            ...
            <div className="bg-black/40 backdrop-blur-sm px-3 py-3 rounded-lg border border-red-500/30 shadow-lg">
              <div className="flex flex-col items-center">
                <div className="flex items-center">
                  <div className="h-2.5 w-2.5 bg-white rounded-full mr-2"></div>
                  <h4 className="font-medium text-white text-xs sm:text-sm">TOPLAM BAĞIŞ</h4>
                </div>
                <motion.div 
                  className="text-xl sm:text-2xl font-bold text-red-500 mt-1.5"
                  animate={{ opacity: [1, 0.9, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  ₺7.514.892
        ...
        >
          ...
          <Link to="/gorevler" className="group relative flex flex-col items-center bg-gradient-to-br from-black/60 to-red-950/30 hover:from-black/70 hover:to-red-950/40 backdrop-blur-md border border-red-700/10 hover:border-red-500/30 p-4 sm:p-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
            ...
            <span className="mt-3 text-sm sm:text-base md:text-lg text-center text-white font-medium tracking-wide">GÖREV DİRİLİŞ</span>
          </Link>
          ...
          <Link to="/halk-manifestolar" className="group relative flex flex-col items-center bg-gradient-to-br from-black/60 to-red-950/30 hover:from-black/70 hover:to-red-950/40 backdrop-blur-md border border-red-700/10 hover:border-red-500/30 p-4 sm:p-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
            ...
            <span className="mt-3 text-sm sm:text-base md:text-lg text-center text-white font-medium tracking-wide">HALK MANİFESTOLARI</span>
          </Link>
          
          {/* Çağrı Butonu */}
          <Link to="/cagri" className="group relative flex flex-col items-center bg-gradient-to-br from-black/60 to-red-950/30 hover:from-black/70 hover:to-red-950/40 backdrop-blur-md border border-red-700/10 hover:border-red-500/30 p-4 sm:p-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 sm:h-9 sm:w-9 md:h-10 md:w-10 text-red-500 group-hover:text-red-400 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
            </svg>
            <span className="mt-3 text-sm sm:text-base md:text-lg text-center text-white font-medium tracking-wide">SESLENİŞ & ÇAĞRI</span>
          </Link>
          
          {/* Katıl Butonu */}
          <Link to="/katil" className="group relative flex flex-col items-center bg-gradient-to-br from-black/60 to-red-950/30 hover:from-black/70 hover:to-red-950/40 backdrop-blur-md border border-red-700/10 hover:border-red-500/30 p-4 sm:p-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 sm:h-9 sm:w-9 md:h-10 md:w-10 text-red-500 group-hover:text-red-400 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
            </svg>
            <span className="mt-3 text-sm sm:text-base md:text-lg text-center text-white font-medium tracking-wide">KATILIM & BAĞIŞ</span>
          </Link>
          ...
          <Link to="/sertifika" className="group relative flex flex-col items-center bg-gradient-to-br from-black/60 to-red-950/30 hover:from-black/70 hover:to-red-950/40 backdrop-blur-md border border-red-700/10 hover:border-red-500/30 p-4 sm:p-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
            ...
            <span className="mt-3 text-sm sm:text-base md:text-lg text-center text-white font-medium tracking-wide">CUMHURİYET SERTİFİKASI</span>
          </Link>
          
          {/* Entegrasyon Butonu */}
          <Link to="/entegrasyon" className="group relative flex flex-col items-center bg-gradient-to-br from-black/60 to-red-950/30 hover:from-black/70 hover:to-red-950/40 backdrop-blur-md border border-red-700/10 hover:border-red-500/30 p-4 sm:p-5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 sm:h-9 sm:w-9 md:h-10 md:w-10 text-red-500 group-hover:text-red-400 transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            <span className="mt-3 text-sm sm:text-base md:text-lg text-center text-white font-medium tracking-wide">ENTEGRASYON SÜRECİ</span>
          </Link>
        ...
        >
          <h3 className="text-xl sm:text-2xl font-medium text-white mb-4">CUMHURİYET GÜNCELLEME SÜRECİ</h3>
          ...
          <div className="mt-4">
            <Link to="/katil" className="inline-block">
              <div className="group relative overflow-hidden rounded-xl bg-gradient-to-b from-red-600/80 to-red-800/80 hover:from-red-500/80 hover:to-red-700/80 px-8 py-4 text-white shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="relative flex items-center justify-center space-x-3">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                  <span className="text-base sm:text-lg font-medium">HEMEN KATIL</span>
                </div>
              </div>
            </Link>
          </div>
