        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-20">
          ...
          >
            ...
            <div className="relative p-8 h-64 flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-emerald-200 transition-colors">DİJİTAL KİMLİK</h3>
                <p className="text-emerald-200 text-base leading-relaxed mb-4">TC Kimlik belgesi ve dijital vatandaşlık</p>
